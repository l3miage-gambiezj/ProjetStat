...
range_date_crolles = data_crolles_f %>% 
  summarize(date_range_crolles = range(local)) ;
range_date_crolles

range_date_voiron = data_voiron_f %>%
  summarize(date_range_voiron = range(local)) ;
range_date_voiron

range_date_rondeau = data_rondeau_f %>%
  summarize(date_range_rondeau = range(local)) ;
range_date_rondeau

range_date_champ_sur_drac = data_champ_sur_drac_f %>%
  summarize(date_range_champ_sur_drac = range(local)) ;
range_date_champ_sur_drac

range_date_grenoble = data_grenoble_f %>%
  summarize(date_range_grenoble = range(local)) ;
range_date_grenoble
